...
public class ContactDAO {
	...
	// 1. ContactListCommand 에서 호출할 selectContactList()
	...
	// 2. ContactViewCommand 에서 호출할 selectContactBycNo()
	...
	public void contactInsert(final String cName, final String cPhone, final String cAddress, final String cEmail, final String cNote) {
		...
		public PreparedStatement createPreparedStatement(Connection conn) throws SQLException {
			String sql = "INSERT INTO CONTACT (CNO, CNAME, CPHONE, CADDRESS, CEMAIL, CNOTE) VALUES"
		+ " (CONTACT_SEQ.NEXTVAL, ?, ?, ?, ?, ?)";
	...
	// 4. ContactDeleteCommand 에서 호출할 contactDelete()
	...
	// 5. ContactUpdateCommand 에서 호출할 contactUpdate()
